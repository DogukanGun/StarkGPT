...
from utils.notification.data import EmailMissingKeysException
...
def send_email(email:str,subject:str,title:str,body:str):
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp_server:
        smtp_server.login(env_map.get_key(EnvironmentKeys.EMAIL.value), env_map.get_key(EnvironmentKeys.EMAIL_PASSWORD.value))
        smtp_server.sendmail(env_map.get_key(EnvironmentKeys.EMAIL.value), email, message.as_string())
